 ...
 * 	@file		MyTemplate_RPI_Header.h
 * 	@version	0.1
 * 	@author		Ludwig Schink
 * 	@date		28.02.2022
 * 	@brief		This file contains the MyTemplate_RPI_Header definitions.*/

#ifndef MYTEMPLATE_RPI_HEADER_H
#define MYTEMPLATE_RPI_HEADER_H
